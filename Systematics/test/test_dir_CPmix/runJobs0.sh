...
/afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Flashgg/Mela_Flashgg/CMSSW_10_6_29/src/flashgg/Systematics/test/test_dir_CPmix/workspaceVbf.py maxEvents=-1 dumpWorkspace=False doSystematics=False applyNNLOPSweight=False recalculatePDFWeights=False doPdfWeights=False vbfTagsOnly=True dumpLHE=False melaEFT=False verboseTagDump=False useParentDataset=False dumpTrees=True metaConditions=/afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Flashgg/Mela_Flashgg/CMSSW_10_6_29/src/flashgg/MetaData/data/MetaConditions/Era2017_legacy_v1.json campaign=Era2017_legacy_v1_Summer20UL_v2 useAAA=True processIdMap=/afs/cern.ch/user/j/jhossain/Hgg_AC_Analysis/Flashgg/Mela_Flashgg/CMSSW_10_6_29/src/flashgg/Systematics/test/test_dir_CPmix/config.json dataset=/GluGluHToGGPlusTwoJets_CPodd_M125_TuneCP5_13TeV-amcatnlopowheg-minlo-pythia8/mukherje-Era2017_legacy_v1_Summer20UL-v0-v0-RunIISummer20UL17MiniAODv2-106X_mc2017_realistic_v9-v2-dba47b1192ec1eec8f63d5c720fe8f2a/USER outputFile=test_dir_CPmix/output_GluGluHToGGPlusTwoJets_CPodd_M125_TuneCP5_13TeV-amcatnlopowheg-minlo-pythia8_mukherje-Era2017_legacy_v1_Summer20UL-v0-v0-RunIISummer20UL17MiniAODv2-106X_mc2017_realistic_v9-v2-dba47b1192ec1eec8f63d5c720fe8f2a_USER.root nJobs=200 jobId=${jobIdsMap[${1}]} 
retval=$?
if [[ $retval != 0 ]]; then
